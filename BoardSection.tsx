...
export function BoardSection() {
  ...
  return (
    <section className="overflow-hidden bg-[#050505] py-20 md:py-24">
      ...
      <Reveal delay={120} className="mt-14">
        ...
        <div className="relative mx-auto max-w-[1150px] px-6">
          <button
            ...
            className={cn(
              "absolute -left-2 top-1/2 z-20 flex h-12 w-12 -translate-y-1/2 items-center justify-center rounded-full border border-gold/30 bg-[#101010]/90 text-gold backdrop-blur-sm transition-all duration-300 hover:border-gold/60 hover:bg-[#1a1a1a]",
          ...
          <button
            ...
            className={cn(
              "absolute -right-2 top-1/2 z-20 flex h-12 w-12 -translate-y-1/2 items-center justify-center rounded-full border border-gold/30 bg-[#101010]/90 text-gold backdrop-blur-sm transition-all duration-300 hover:border-gold/60 hover:bg-[#1a1a1a]",
        ...
        <div
          ...
          className="mt-6 flex snap-x snap-mandatory gap-6 overflow-x-auto scroll-smooth px-[calc(50vw-16rem)] md:px-[calc(50%-25rem)] pb-4"
        ...
        >
          {board.map((member, index) => (
            <button
              ...
              className={cn(
                "relative h-80 w-60 shrink-0 snap-center overflow-hidden rounded-2xl border border-gold/15 bg-[#101010] p-0 text-left transition-all duration-500 ease-out md:h-96 md:w-72",
                activeIndex === index ? "z-20 scale-105 border-gold/40 shadow-[0_18px_45px_rgba(212,175,55,0.16)]" : "scale-100 opacity-70",
              )}
            >
              <img
                src={member.image}
